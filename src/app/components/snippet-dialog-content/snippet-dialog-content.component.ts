...
@Component({
  selector: 'snippet-dialog-content',
  standalone: true,
  template: `
    ...
    <div class="tabs-container">
      <ul aria-labelledby="tabs-title" role="tablist">
        ...
        <li [attr.aria-selected]="activePanelId() === 'ts'" role="tab">
          <a id="ts-tab" (click)="activePanelId.set('ts'); (false)" href="#ts">
            TS
          </a>
        </li>
      </ul>
  ...
  `,
  styleUrl: './snippet-dialog-content.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SnippetDialogContentComponent {
