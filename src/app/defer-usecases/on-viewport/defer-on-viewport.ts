...
@Component({
  ...
  template: `
    <app-box>
      <content>
        📚 <code>viewport</code> would trigger the deferred block when the
        specified content enters the viewport using the
        <a
      ...
      <content
        >📚 <code>viewport</code> trigger
        <strong>with no parameters</strong> can only be placed on an
        <code>&#64;defer</code> that has a <code>&#64;placeholder</code> block
        with exactly one root element node.</content
      >
    </app-box>
    ...
    <div class="scroll-container box">
      ...
      <div>
        @defer (on viewport) {
        <lazy-on-viewport>
          <article>some <code>&#64;defer (on viewport)</code> content</article>
        </lazy-on-viewport>
        <lazy-shared>
          <article>some <code>&#64;defer (on viewport)</code> content</article>
        </lazy-shared>
